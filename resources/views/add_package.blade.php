...
<div class= "fs-4 mt-3 ms-5 package-lead fw-semibold"><span><a href="{{ route('booking') }}" class="text-decoration-none fs-4 text-dark package-lead fw-semibold">Package</a></span> > Add Travel Package</div>

<div class="container my-3 py-5">
   <div class="card w-50 h-auto mx-auto shadow package-lead p-4">
        <form action="{{ route('upload_package') }}" method="POST" enctype="multipart/form-data">
        @csrf
            <!-- Package Name -->
            <div class="mb-3">
                <label for="packageName" class="form-label">Package Name</label>
                <input type="text" class="form-control package-lead" id="packageName" placeholder="Lakeside Motel Waterfront" name="package_name">
            </div>

            <!-- Description -->
            <div class="mb-3">
                <label for="description" class="form-label">Description</label>
                <textarea class="form-control package-lead" id="description" rows="5" placeholder="Description" name="description"></textarea>
            </div>

            <!-- Days -->
            <div class="mb-3">
                <label for="days" class="form-label">Days</label>
                <input type="text" class="form-control package-lead" id="days" placeholder="4 Nights 5 Days" name="staying_days">
            </div>
...
<a href="#" class=" text-dark fw-semibold text-decoration-none"> + Next Day</a>
    ...
    <div class="col-4 col-sm-6 col-md-4">
        <div class="small-box" style="border: 1px solid black; cursor: pointer;" onclick="document.getElementById('firstimage').click()">
            <img id="preview1" style="width: 100%; height: 150px; object-fit: cover; display: none;" alt="Image Preview" />
...
@endsection
@section('styles')
<link rel="stylesheet" href="{{ asset('css/add_package.css') }}">
@endsection
@section('scripts')
<script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js" integrity="sha512-AA1Bzp5Q0K1KanKKmvN/4d3IRKVlv9PYgwFPvm32nPO6QS8yH1HO7LbgB1pgiOxPtfeg5zEn2ba64MUcqJx6CA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script src="https://code.jquery.com/jquery-3.7.1.min.js" integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script>
<script src="{{ asset('js/add_package.js') }}"></script>
@endsection